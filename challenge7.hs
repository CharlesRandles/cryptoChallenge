{- Mostly working out how the Crypto.Cipher.AES package works -}
...
plain = decryptECB initVector cipher

cipher = pack 
         $ toText 
         $ base64Decode
         $ concat ["CRIwqt4+szDbqkNY+I0qbDe3LQz0wiw0SuxBQtAM5TDdMbjCMD/venUDW9BL",
