...
ciphers :: [Cipher]
ciphers = [hexDecode s | s <- hexCiphers]

decrypt cs = map best cs

isOk (key, score, plaintext) = (score > 3.0) && (score < 4.0)

candidates set = concat $ map dodgies set

{- Dwarf Legend Test
tolkienPlain = fromText "Far below the deepest delvings of the dwarves the earth is gnawed by nameless things"
tolkienKey = charToKey 'W'
tolkienCipher = xorEncode tolkienPlain tolkienKey
tolkienCiphers = [tolkienCipher]
--}

challenge3 = hexDecode "1b37373331363f78151b7f2b783431333d78397828372d363c78373e783a393b3736"
solve3 = ppt $ decrypt [challenge3 ]

fakeScore :: (Key, Plain) -> (Key, Double, Plain)
fakeScore (k,p) = (k, -1.0, p)

pq ps = ppt $ map fakeScore ps

ppt [] = do return ()
ppt((k, s, p):xs) = do
        putStrLn $ (toText k) ++ ":" ++ (toText p) ++ " Score: " ++ show s
        ppt xs

hexCiphers =  ["1730237133343d3e267125393471353434213422257135343d273e3f2271",
...
Frankly, you're probably not that smart.
...
If you're smart, you've solved it.
...
Have you seen the end of the file yet?
...
Not very interesting down there, is it?
...
Smart, intelligent, sweet-smelling people will have worked it out.
...
"7b5a4215415d544115415d5015455447414c155c46155f4058455c5b52" xor '5' is "Now that the party is jumping"
-}